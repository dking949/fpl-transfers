...
handler_wrapper_kwargs = {'function_name': 'aws-fpl-transfer-abuse-api-dev-getTransfers', 'timeout': 6}
try:
    user_handler = serverless_sdk.get_user_handler('transferNightmares.getTransfers')
